...
// FUNCTION 1. SETUP
bool PhongShader::startup()
{
	// initialise gizmo primitive counts
	Gizmos::create(64000, 64000, 64000, 64000);

	// CREATE: TEXTURE for Bunny - the earth diffuse.jpg TEMPORARILY - DONT WORRY!
...
void PhongShader::update(float deltaTime)
{
...
void PhongShader::generateTexturedQuad()
{
}

void PhongShader::generateTexturedBunny()
{
	// MODIFY - THIS IS QUAD DATA FOR EARTH MAP
	float vertexData[] =
	{
		-5, 0, 5, 1, 0, 1,
		5, 0, 5, 1, 1,1,
